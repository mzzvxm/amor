      ...
      <div className="relative z-10 container mx-auto px-4 py-8 space-y-16">
        ...
        <header className="text-center py-16">
          <div className="flex items-center justify-center gap-4 mb-6">
            <Heart className="text-blood-red-500 animate-pulse-heart fill-current" size={40} />
        ...
        <footer className="text-center py-16">
          <div className="glass-effect rounded-xl p-8 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Heart className="text-blood-red-500 fill-current animate-pulse-heart" size={24} />
              <Heart className="text-blood-red-400 fill-current animate-pulse-heart" size={20} />
              <Heart className="text-blood-red-500 fill-current animate-pulse-heart" size={24} />
            </div>
